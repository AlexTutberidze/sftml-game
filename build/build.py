...
os.system("g++ ../src/server.cpp -o ../bin/server.exe -lsfml-graphics -lsfml-window -lsfml-system -lsfml-network")
os.system("g++ ../src/client.cpp -o ../bin/client.exe -lsfml-graphics -lsfml-window -lsfml-system -lsfml-network")
